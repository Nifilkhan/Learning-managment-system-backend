...
export const deleteSection = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error occured while deleting the section" , error: error.message });
  }
};
...
export const editSection = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error occurred while updating the section", error: error.message });
  }
};
